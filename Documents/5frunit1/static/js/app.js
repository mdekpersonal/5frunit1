...
const durationOverrides = {
    // Section 1 (Leçons Orales - Dialogues) - 80 seconds
    'section-0-vocab': 80,  // Dialogues: 80 seconds
    // Section 2 (Conjugaison & Temps) - 80 seconds
    'section-1-vocab': 80,  // Conjugaison: 80 seconds
    // Section 3 (Grammaire & Structure) - 58 seconds
    'section-2-vocab': 58,  // Grammaire: 58 seconds
    // Section 4 (Orthographe & Accords) - 60 seconds
    'section-3-vocab': 60,  // Orthographe: 60 seconds
    // Section 5 (Vocabulaire) - 63 seconds
    'section-4-vocab': 63,  // Vocabulaire: 63 seconds
};
